...
__kernel void dotproduct_precompiled_MapKernel_mul_arity_2( __global float* skepu_output, __global float *a, __global float *b,   size_t skepu_n, size_t skepu_base)
{
...
#if !0
		skepu_output[skepu_i] = mul(a[skepu_i], b[skepu_i]);
#else
		skepu_multiple skepu_out_temp = mul(a[skepu_i], b[skepu_i]);
